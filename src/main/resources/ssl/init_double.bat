...
keytool -genkey -alias serverAlias -keysize 2048 -validity 365 -keyalg RSA -dname "CN=localhost" -keypass serverKeyPassDemo -storepass serverStorePassDemo -keystore server.jks

:: 2.生成Netty服务端自签名证书：
keytool -export -alias serverAlias -keystore server.jks -storepass serverStorePassDemo -file server.cer

:: 3.生成客户端的密钥对和证书仓库：
keytool -genkey -alias clientAlias -keysize 2048 -validity 365 -keyalg RSA -dname "CN=localhost" -keypass clientKeyPassDemo -storepass clientStorePassDemo -keystore client.jks
